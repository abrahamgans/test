...
class IbParser
{
    ...
    function getBalance( $bank = 'BCA', $username, $password )
    {
    ...
    function getTransactions( $bank = 'BCA', $username, $password )
    {
...
class BCAParser
{
    ...
    function __construct( $conf )
    {
        ...
        // echo $this->post_time['start']['y'].'<br>';
        // echo $this->post_time['start']['m'].'<br>';
        // echo $this->post_time['start']['d'].'<br>';
        // echo $this->post_time['end']['y'].'<br>';
        // echo $this->post_time['end']['m'].'<br>';
        // echo $this->post_time['end']['d'].'<br>';
        // die;
    }
